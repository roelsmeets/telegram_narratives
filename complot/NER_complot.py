...
for filename in os.listdir('/Users/roelsmeets/desktop/complot/Telegram_data_to_do'):
    if filename.endswith('.csv'):
        print ('computing NLP for:', filename)
        with open(os.path.join('/Users/roelsmeets/desktop/complot/Telegram_data_to_do', filename), encoding='latin-1') as csvfile:
